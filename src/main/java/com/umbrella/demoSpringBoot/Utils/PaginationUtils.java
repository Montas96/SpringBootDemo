...
public class PaginationUtils {
    ...
    public static HttpHeaders generatePaginationHeaders(UriComponentsBuilder builder, Page page) {
        ...
        link.append(prepareLink(builder, page.getTotalPages() - 1, pageSize, "last")).append(",").append(prepareLink(builder, 0, pageSize, "first"));
